...
const projects = [
  {
    ...
    githubUrl: "https://github.com/Apollo1729/ecommerce-store.git",
  },
  {
    id: 2,
    title: "SignalList AI Stock App",
    description:
      "AI-powered modern stock market app built with Next.js, Shadcn, Better Auth, and Inngest! Track real-time prices, set personalized alerts, explore company insights, and manage watchlists. The admin dashboard allows managing stocks, publishing news, and monitoring user activity",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/Apollo1729"
          >
